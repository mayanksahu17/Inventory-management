...
export default function Component() {
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-1 grid grid-cols-1 md:grid-cols-[1fr_300px]">
        <div className="bg-muted/40 p-8 md:p-12">
          <section className="max-w-2xl">
            <h1 className="text-4xl font-bold mb-4">Welcome to Montery Warehouse</h1>
          ...
          <section className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <CardContent className="flex items-center gap-4">
                ...
                <div>
                  <Link href={'/admin/perishable/food'}>
                  <h3 className="text-lg font-medium">Food</h3>
                  <p className="text-muted-foreground">Explore our selection of fresh produce and packaged goods.</p>
                  </Link>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex items-center gap-4">
                ...
                <div>
                  <Link href={'/admin/non-perishable/waste'}>
                  <h3 className="text-lg font-medium">Waste</h3>
                  <p className="text-muted-foreground">Find the right waste management solutions for your business.</p>
                  </Link>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex items-center gap-4">
                ...
                <div>
                  <Link href={'/admin/non-perishable/construction'}>
                  <h3 className="text-lg font-medium">Construction</h3>
                  <p className="text-muted-foreground">Browse our selection of building materials and tools.</p>
                  </Link>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="bg-background p-6 border-l">
          ...
          <nav className="space-y-2">
            <Link href="#" className="flex items-center gap-2 hover:underline" prefetch={false}>
              <ShipIcon className="w-5 h-5 text-muted-foreground" />
              Shipping
            </Link>
            <Link href="#" className="flex items-center gap-2 hover:underline" prefetch={false}>
